...
<picture>
  ...
  <img alt="Topics: String, String Matching, Z Algorithm, Knuth–Morris–Pratt Algorithm, Boyer–Moore String-Search Algorithm — best runtime 259 ms (Beats 79%), best memory 43.7 MB (Beats 48%)" src="panel-dark.svg">
</picture>
...
| # | File | Language | Date |
|:-:|------|:--------:|:----:|
| 1 | [sol1.java](./sol1.java) | `Java` | 2026-09-25 |
| 2 | [sol2.java](./sol2.java) | `Java` | 2026-09-25 ← **latest** |
